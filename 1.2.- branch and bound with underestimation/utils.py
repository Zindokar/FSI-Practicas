...
class SortedListByCostAndHeuristic(Queue):
    """Sorted list by path cost plus heuristic of the element."""
    ...
    def append(self, item):
        self.A.append(item)
        self.sortByPathCostAndHeuristic()
    ...
    def sortByPathCostAndHeuristic(self):
        self.A.sort(key=lambda element: element.path_cost + self.problem.h(element))
